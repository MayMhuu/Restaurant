...
export default function NewsArticle() {
  const checkedBundleType = (articalBody, key) => {
    if (key === "text") {
  ...
  return (
    <div className="container mx-auto sm:px-0 w-4/5">
      {articelJson.map((articalBody, index) => {
        return (
          <div className="flex flex-wrap mt-10" key={index}>
            ...
            <div className="w-full sm:w-full md:w-full lg:w-3/4 xl:w-3/4 pt-14">
              <div className="w-full h-full text-black pr-5 ">
                <FollowPage />
                {checkedBundleType(articalBody, "text")}
